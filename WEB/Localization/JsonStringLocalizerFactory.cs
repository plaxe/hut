...
public class JsonStringLocalizerFactory : IStringLocalizerFactory
{
    ...
    public JsonStringLocalizerFactory(string resourcesPath, ILoggerFactory loggerFactory, IMemoryCache memoryCache = null)
    {
    ...
    public IStringLocalizer Create(Type resourceSource)
    {
        ...
        return new JsonStringLocalizer<object>(_resourcesPath, resourceName, 
            _loggerFactory.CreateLogger<JsonStringLocalizer<object>>(), _memoryCache);
    }
